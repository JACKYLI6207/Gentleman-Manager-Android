      ...
      <div class="remote-browse-actions">
        ...
        <div class="remote-browse-actions-right">
          <div class="remote-upload-menu-wrap">
            ...
            <div v-if="uploadMenuOpen" class="remote-upload-menu" @click.stop>
          ...
          <button
            type="button"
            class="tool tool--ghost remote-browse-transfer"
            :disabled="remoteBusy"
            @click="startDownload"
          >
      ...
      <ul v-else class="remote-browse-list">
        ...
        >
          <div class="remote-browse-row">
            ...
            >
              <span class="remote-browse-icon">{{ entry.isDir ? '📁' : '📄' }}</span>
              <span class="remote-browse-name">{{ entry.name }}</span>
